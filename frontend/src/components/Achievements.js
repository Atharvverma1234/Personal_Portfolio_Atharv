...
const achievements = [
  {
    id: 1,
    title: 'Winner & Top Contributor',
    organization: 'Social Winter of Code 2026',
    date: 'March 2026',
    icon: '🥇',
    description: 'Recognized for exceptional contributions and leadership in the open-source community.',
    metric: 'Top 5% of contributors',
  ...
  },
  {
    ...
    organization: 'Kharagpur Winter of Code 2024',
    date: 'March 2025',
    icon: '🥈',
    description: 'Successfully completed Kharagpur Winter of Code 2024 with 25 pull requests merged and 7 commits.',
    metric: 'Top 10% of contributors',
  ...
  },
  {
    ...
    date: 'Feb 2024',
    icon: '🏆',
    description: 'Awarded for outstanding academic performance and leadership potential.',
    metric: 'Top 10% of applicants',
