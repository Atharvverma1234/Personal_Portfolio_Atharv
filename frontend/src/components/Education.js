...
const blocks = [
  {
    ...
    subDegree: 'Bachelor of Technology in Computer Engineering',
    grade: 'GPA 3.9 / 4.0',
    duration: '2016 – 2022',
    description:
      'Specialized in Artificial Intelligence and Machine Learning. Focused on Software Engineering and Web Technologies with a thesis on transformer-based models for code generation.',
    tags: ['AI / ML', 'Deep Learning', 'NLP', 'Distributed Systems'],
  },
  {
    type: 'school',
    typeLabel: '📚 School',
    ...
    duration: '2012 – 2016',
    description:
      'Graduated with distinction in the Science and Mathematics stream. Active member of the robotics and coding club, winning regional competitions in 2015.',
    tags: ['Mathematics', 'Physics', 'Robotics', 'Coding Club'],
  },
];
