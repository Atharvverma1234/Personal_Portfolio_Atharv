  ...
  return (
    <footer className="bg-gray-800 text-white">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition duration-300 transform hover:scale-110"
