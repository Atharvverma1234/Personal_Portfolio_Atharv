      ...
      <div className="container mx-auto px-6">
          ...
          <div className="overflow-hidden py-8">
            ...
            >
              {[...skillSets, ...skillSets].map((skill, index) => (
                ...
                >
                  <div className="w-32 h-32 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center justify-center shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-110 hover:-translate-y-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div 
              key={index}
              className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition duration-300"
            >
              ...
              <div className="text-3xl font-bold text-gray-800 dark:text-white">{category.count}+</div>
