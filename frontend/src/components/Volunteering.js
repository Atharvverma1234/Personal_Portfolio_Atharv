...
const Volunteering = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position:'absolute', borderRadius:'50%', filter:'blur(110px)', pointerEvents:'none', width:380, height:380, top:-80, right:-60, background:t.glow1, transition:'background 0.35s' }} />
      <div style={{ position:'absolute', borderRadius:'50%', filter:'blur(110px)', pointerEvents:'none', width:320, height:320, bottom:-60, left:-40, background:t.glow2, transition:'background 0.35s' }} />
